const testimonials = [
  {
    ...
    quote: "何をすればいいか分からず焦っていましたが、診断で出たSNS運用のタスクを始めたら、3ヶ月でフォロワー500人を達成。就活の自己PRで堂々と話せるエピソードになりました。",
    person: "大学2年・経済学部",
    type: "ガクチカ型",
  },
  {
    avatar: "https://images.unsplash.com/photo-1614644147724-2d4785d69962?w=80&h=80&fit=crop&crop=faces",
    quote: "英語は好きだけど、どう活かすか悩んでいました。英語カフェでのボランティアから始め、今では短期留学を計画中。TOEICも150点アップしました。",
    person: "大学1年・文学部",
    type: "留学型",
  },
  {
    avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=80&h=80&fit=crop&crop=faces",
    quote: "何か武器が欲しいと思っていた。診断後にITパスポートの学習計画を立て、2ヶ月で合格。次は基本情報技術者に挑戦中です。具体的な行動プランがあると全然違います。",
    person: "大学3年・法学部",
    type: "資格型",
  },
  {
    avatar: "https://images.unsplash.com/photo-1543269865-cbf427effbad?w=80&h=80&fit=crop&crop=faces",
    quote: "人と関わるのが好きだけど居場所がなかった。KAIWAIで紹介されたサークルに参加し、50人規模のイベント運営も経験。人前で話す自信がつきました。",
    person: "大学1年・工学部",
    type: "サークル型",
  },
];
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                />
                <span style={{ fontSize: 13, color: "var(--color-muted)", letterSpacing: "0.04em" }}>{t.person}</span>
              </div>
            </div>
          ))}
        </div>
