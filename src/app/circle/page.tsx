    ...
    <div style={{ minHeight: "100vh", background: "var(--color-bg)", fontFamily: "var(--font-sans)" }}>
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "48px 20px" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div style={{
            ...
            <svg viewBox="0 0 24 24" fill="none" style={{ width: 20, height: 20 }}>
              ...
              <path d="M16 20c0-2.5 1.5-4.5 3.5-5.5" stroke="rgba(255,255,255,0.6)" strokeWidth="2" strokeLinecap="round" />
            </svg>
            サークル
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Link href="/circle/search" style={{ textDecoration: "none" }}>
            <div style={{
          ...
          <Link href="/circle/promote" style={{ textDecoration: "none" }}>
            <div style={{
              background: "var(--color-surface)", border: "2px solid var(--color-border)", borderRadius: 20, padding: "28px 24px",
              display: "flex", alignItems: "center", gap: 20,
            }}>
          ...
          <Link href="/circle/sports" style={{ textDecoration: "none" }}>
            <div style={{
