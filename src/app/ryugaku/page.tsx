    ...
    <div style={{ minHeight: "100vh", background: "var(--color-bg)", fontFamily: "var(--font-sans)" }}>
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "32px 20px 48px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Link href="/ryugaku/prepare" className="link-card">
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "var(--font-serif)", fontWeight: 900, fontSize: 18, color: "var(--color-primary)", marginBottom: 6 }}>まず英語力をつけたい</div>
              <div style={{ fontSize: 13, color: "var(--color-muted)", lineHeight: 1.6 }}>TOEIC対策・英語学習の進め方</div>
            </div>
          ...
          <Link href="/ryugaku/countries" className="link-card">
            <div className="icon-circle">
              <svg viewBox="0 0 32 32" fill="none" style={{ width: 28, height: 28 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "var(--font-serif)", fontWeight: 900, fontSize: 18, color: "var(--color-primary)", marginBottom: 6 }}>留学先を決めたい</div>
              <div style={{ fontSize: 13, color: "var(--color-muted)", lineHeight: 1.6 }}>国選び・期間・予算・エージェント</div>
            </div>
            <svg viewBox="0 0 24 24" fill="none" className="link-card-arrow" style={{ width: 22, height: 22 }}>
              <path d="M9 18l6-6-6-6" stroke="var(--color-accent)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ...
          <Link href="/ryugaku/cafe" className="link-card link-card-accent">
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "var(--font-serif)", fontWeight: 900, fontSize: 18, color: "#fff", marginBottom: 6 }}>英語カフェに参加したい</div>
              <div style={{ fontSize: 13, color: "rgba(255,255,255,0.85)", lineHeight: 1.6 }}>気軽に英語を使えるコミュニティ</div>
            </div>
            <svg viewBox="0 0 24 24" fill="none" className="link-card-arrow" style={{ width: 22, height: 22 }}>
